...
BOT_TOKEN = "8364985405:AAE1tkBYJtWLTaWVvqpN8-yv7fc3P7gBgik"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Доступные команды:\n"
        "/bandit - игра в бандит\n"
        "/rulet - игра в рулетку\n\n"
        "💵 Начальный баланс: 1000 монет"
    )

# Команда /bandit
async def bandit_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.effective_user.id
    username = update.effective_user.username
...
# Команда /rulet
async def rulet_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    user_id = update.effective_user.id
    username = update.effective_user.username
...
def main():
    ...
    application.add_handler(CommandHandler("bandit", bandit_command))
    application.add_handler(CommandHandler("rulet", rulet_command))
    ...
    print("/bandit - игра в бандит")
    print("/rulet - игра в рулетку")
